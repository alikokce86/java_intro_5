...
public class MinAndMaxMethods {
    ...
    public static void main(String[] args) {
        ...
        // Math.max(Math.max(input1, Math.max(input2, input3)),Math.max(input4, input5)));  // 5 numbers way

        int minNumber = Math.min(80, 27);  // can take 2 numbers

        int minNumber2 = Math.min(Math.min(80, 27), 2);  // 3 numbers way
